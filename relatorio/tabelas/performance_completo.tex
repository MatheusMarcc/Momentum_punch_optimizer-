\begin{table}[htbp]
\centering
\caption{Desempenho da estratégia contra os benchmarks — período de completo.}
\label{tab:performance-completo}
...
ESG estática (ISUS11/GOVE11/REVE11) & 6.89\% & 14.52\% & -0.30 & -0.46 & 0.36 & -19.39\% & 94\% dos dias (maior sequência: 502 dias) \\
